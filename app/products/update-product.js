$(document).ready(function () {
    ...
    $(document).on('click', '.update-product-button', function () {
        ...
        $.getJSON("http://localhost/ninja_code_api/product/read_one.php?id=" + id, function (data) {
            ...
            $.getJSON("http://localhost/ninja_code_api/category/read.php", function (data) {
...
<form id='update-product-form' action='#' method='post' border='0'>
    ...
    $(document).on('submit', '#update-product-form', function () {
        ...
        $.ajax({
            url: "http://localhost/ninja_code_api/product/update.php",
            type: "POST",
